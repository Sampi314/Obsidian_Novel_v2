...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      /* Container */
      '.cs-sheet { max-width: 880px; margin: 0 auto; padding: 24px; font-family: "Source Serif 4", "Georgia", serif; color: var(--text, #d4cbbf); animation: cs-enter 0.6s ease-out; }',
      ...
      '.cs-header::before { content: ""; position: absolute; top: -1px; left: 0; right: 0; height: 2px; background: linear-gradient(90deg, transparent, var(--accent-dim, #8a7549), transparent); opacity: 0.5; }',
      ...
      '.cs-avatar-wrap { flex-shrink: 0; width: 160px; height: 160px; border-radius: 12px; overflow: hidden; border: 2px solid var(--accent-dim, #8a7549); box-shadow: 0 0 0 4px rgba(201,169,110,0.06), 0 8px 32px rgba(0,0,0,0.35); background: var(--ink, #1a1714); display: flex; align-items: center; justify-content: center; transition: box-shadow 0.3s ease, border-color 0.3s ease; }',
      '.cs-avatar-wrap:hover { box-shadow: 0 0 0 4px rgba(201,169,110,0.12), 0 8px 32px rgba(0,0,0,0.45); border-color: var(--accent, #c9a96e); }',
      ...
      '.cs-name { font-family: "Cormorant Garamond", serif; font-size: 2.3rem; font-weight: 700; color: var(--accent, #c9a96e); line-height: 1.15; margin-bottom: 0; text-shadow: 0 0 40px rgba(201,169,110,0.12); }',
      '.cs-hantu { font-size: 1.3rem; color: var(--muted, #7a7067); font-weight: 400; letter-spacing: 3px; margin-top: 4px; margin-bottom: 4px; }',
      ...
      '.cs-badge-archetype { border: 1px solid var(--accent, #c9a96e); color: var(--accent, #c9a96e); background: rgba(201,169,110,0.08); }',
      '.cs-badge-status { color: #fff; box-shadow: 0 2px 8px rgba(0,0,0,0.25); }',
      '.cs-meta { font-size: 0.9rem; color: var(--muted, #7a7067); margin: 6px 0 2px; }',
      '.cs-tong-luc { font-size: 1rem; color: var(--accent, #c9a96e); font-weight: 600; margin-top: 10px; padding-top: 10px; border-top: 1px solid rgba(201,169,110,0.08); letter-spacing: 0.5px; }',
      ...
      '.cs-timeline-label { font-size: 0.7rem; color: var(--muted, #7a7067); text-transform: uppercase; letter-spacing: 2.5px; margin-bottom: 14px; font-weight: 600; }',
      ...
      '.cs-timeline-line { position: absolute; top: 50%; left: 24px; right: 24px; height: 2px; background: linear-gradient(90deg, var(--accent-dim, #8a7549), var(--accent, #c9a96e), var(--accent-dim, #8a7549)); transform: translateY(-50%); z-index: 0; opacity: 0.6; }',
      '.cs-arc-btn { position: relative; z-index: 1; width: 38px; height: 38px; border-radius: 50%; border: 2px solid var(--accent-dim, #8a7549); background: var(--ink, #1a1714); color: var(--text, #d4cbbf); font-size: 0.82rem; font-weight: 700; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); font-family: inherit; }',
      '.cs-arc-btn:hover { border-color: var(--accent, #c9a96e); background: rgba(201,169,110,0.12); transform: scale(1.1); }',
      '.cs-arc-btn.cs-active { background: var(--accent, #c9a96e); color: var(--void, #0a0908); border-color: var(--accent, #c9a96e); box-shadow: 0 0 16px rgba(201,169,110,0.3); transform: scale(1.05); }',
      '.cs-methods { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 14px; }',
      '.cs-method-tag { display: inline-block; padding: 4px 14px; font-size: 0.75rem; border-radius: 20px; background: rgba(201,169,110,0.07); color: var(--accent-bright, #e4c98a); border: 1px solid rgba(201,169,110,0.14); transition: all 0.2s ease; letter-spacing: 0.3px; }',
      ...
      '.cs-radar-grid { fill: none; stroke: var(--accent-dim, #8a7549); stroke-width: 0.5; opacity: 0.35; }',
      '.cs-radar-axis { stroke: var(--accent-dim, #8a7549); stroke-width: 0.5; opacity: 0.25; }',
      '.cs-radar-poly { fill: var(--accent, #c9a96e); fill-opacity: 0.15; stroke: var(--accent, #c9a96e); stroke-width: 2; stroke-dasharray: 800; animation: cs-radar-draw 1s ease-out forwards; filter: drop-shadow(0 0 6px rgba(201,169,110,0.25)); transition: all 0.5s cubic-bezier(0.4, 0, 0.2, 1); }',
      '.cs-radar-dot { fill: var(--accent-bright, #e4c98a); stroke: var(--void, #0a0908); stroke-width: 2; transition: all 0.5s cubic-bezier(0.4, 0, 0.2, 1); }',
      '.cs-radar-label { fill: var(--text, #d4cbbf); font-size: 11px; font-family: "Source Serif 4", serif; text-anchor: middle; }',
      '.cs-radar-value { fill: var(--accent-bright, #e4c98a); font-size: 10.5px; font-family: "Source Serif 4", serif; text-anchor: middle; font-weight: 700; }',
      ...
      '.cs-tab-btn { background: none; border: none; border-bottom: 2px solid transparent; color: var(--muted, #7a7067); font-family: "Cormorant Garamond", serif; font-size: 0.9rem; padding: 12px 20px; cursor: pointer; white-space: nowrap; transition: all 0.3s ease; letter-spacing: 0.3px; }',
      '.cs-tab-btn:hover { color: var(--text, #d4cbbf); background: rgba(201,169,110,0.04); }',
      '.cs-tab-btn.cs-active { color: var(--accent, #c9a96e); border-bottom-color: var(--accent, #c9a96e); background: rgba(201,169,110,0.06); }',
      '.cs-tab-content { padding: 24px 8px; min-height: 140px; animation: cs-fade 0.35s ease; }',
      '.cs-tab-content .cs-empty { color: var(--muted, #7a7067); font-style: italic; }',

      /* Markdown rendered content in tabs */
      '.cs-tab-content h1, .cs-tab-content h2, .cs-tab-content h3 { color: var(--accent, #c9a96e); font-family: "Cormorant Garamond", serif; margin: 20px 0 10px; }',
      ...
      '.cs-tab-content strong { color: var(--accent-bright, #e4c98a); }',
      '.cs-tab-content blockquote { border-left: 3px solid var(--accent-dim, #8a7549); padding: 10px 18px; margin: 14px 0; color: var(--muted, #7a7067); font-style: italic; background: rgba(201,169,110,0.03); border-radius: 0 8px 8px 0; }',
      ...
      '.cs-inv-name { flex: 1; color: var(--text, #d4cbbf); font-weight: 500; }',
      '.cs-inv-type { display: inline-block; padding: 2px 10px; font-size: 0.72rem; border-radius: 12px; background: rgba(201,169,110,0.1); color: var(--accent, #c9a96e); border: 1px solid rgba(201,169,110,0.15); }',
      ...
      '.cs-rel-name { font-family: "Cormorant Garamond", serif; font-weight: 700; color: var(--accent, #c9a96e); font-size: 1.1rem; margin-bottom: 4px; }',
      '.cs-rel-desc { color: var(--muted, #7a7067); font-size: 0.85rem; margin-bottom: 14px; font-style: italic; }',
      '.cs-feel-row { display: flex; align-items: center; gap: 10px; margin: 7px 0; }',
      '.cs-feel-label { width: 36px; font-size: 0.75rem; color: var(--muted, #7a7067); text-align: right; flex-shrink: 0; }',
  ...
  function createAvatarPlaceholder() {
    ...
    var circle = svgEl('circle', { cx: '32', cy: '22', r: '12', fill: 'var(--muted, #7a7067)' });
    var body = svgEl('ellipse', { cx: '32', cy: '54', rx: '20', ry: '14', fill: 'var(--muted, #7a7067)' });
