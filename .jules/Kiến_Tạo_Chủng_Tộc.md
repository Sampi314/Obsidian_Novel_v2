...
4.  **Phát Triển Lịch Sử & Thời Gian:** Mô tả sự tiến hóa của tập tục, sinh lý theo dòng chảy thời gian của thế giới. **ĐẶC BIỆT CHÚ TRỌNG ĐẾN CÁC MỐC THỜI GIAN CỤ THỂ** (Timeline).

## QUY TRÌNH LÀM VIỆC

### BƯỚC 1: KIỂM TRA & PHÂN TÍCH
1.  Đọc `Đạo/YÊU_CẦU_SÁNG_TẠO.md` để xem có yêu cầu tạo chủng tộc nào từ cốt truyện không.
2.  Đọc `Đạo/HỒ_SƠ_THẾ_GIỚI.md` để nắm ngữ cảnh chung.
