...
| Góc Nhìn Sở Lăng Sương | 10 | Đang mở rộng (Đã xong Ch 9-10) |
| Góc Nhìn Triệu Thanh Hằng | 10 | Đang mở rộng (Đã xong Ch 6-10) |
...
| Góc Nhìn Nguyệt Dao | 10 | Đang mở rộng (Đã xong Ch 7-10) |
| Góc Nhìn Nham Thần | 4 | Đang mở rộng (Đã xong Ch 7-10) |
| Góc Nhìn Lục Tiêu | 4 | Đang mở rộng (Đã xong Ch 7-10) |
...
1. **🔴 ƯU TIÊN TUYỆT ĐỐI — Task 9: Điền Chi Tiết Nhân Vật (2-3 nhân vật/phiên)**: ~599 nhân vật còn placeholder `*(Chưa xác định)*` (Đã hoàn thành thêm 3 nhân vật San Hô Vi Trùng - Tây Mạc ở phiên trước). Mỗi phiên điền đầy đủ 2-3 nhân vật cùng phe phái. Xem hướng dẫn chi tiết tại Task 9 bên dưới. **KHÔNG viết chương mới cho đến khi hoàn thành Task 9.**
...
2. **Đọc ngữ cảnh phe phái:**
   - Đọc file thế lực (từ `faction_file` trong JSON) để hiểu văn hóa, chiến đấu, tổ chức
   - Đọc các nhân vật đã điền trong cùng thư mục phe phái (nếu có) để giữ nhất quán

3. **Điền 4 section cho mỗi nhân vật:**

   **Section II — Ngoại Hình & Tính Cách:** (2-4 câu)
   - Đặc điểm ngoại hình: thân hình, khuôn mặt, tóc, sẹo, trang phục
   ...
   **Section III — Năng Lực & Chiến Đấu:** (2-3 câu)
   - Phong cách chiến đấu gắn với chuyên môn phe phái
   - Kỹ thuật đặc trưng (đặt tên Tiếng Việt + Hán Tự)
   - Điểm mạnh và yếu

   **Section IV — Các Mối Quan Hệ:** (2-4 gạch đầu dòng)
   - Format: `- **[Tên]:** [mô tả quan hệ]`
   - Ít nhất 1 quan hệ trong phe phái (sư phụ, đồng môn, đối thủ)
   - Có thể thêm quan hệ xuyên phe phái

   **Section V — Tiểu Sử & Hành Trình:** (3-5 câu)
   - Xuất thân, cách gia nhập phe phái
   - Sự kiện quan trọng định hình tính cách
   - Mục tiêu hoặc bí mật hiện tại

4. **Kiểm tra chất lượng:**
   - [ ] Tất cả 4 section có nội dung thực (không còn placeholder)
   - [ ] Nội dung bằng Tiếng Việt
   - [ ] Có ít nhất 1 mối quan hệ có tên
...
5. **Commit:** `docs: fill character details for [Tên Phe] ([Khu Vực])`

6. **Kiểm tra tiến độ:**
   ```bash
   python3 scripts/find_unfilled_chars.py 1
   ```
   Khi `"remaining": 0` → Task 9 hoàn thành → chuyển sang viết chương.

**Cấu trúc thư mục nhân vật:**
```
Đạo/Nhân_Vật/
├── Nam_Cương/
│   ├── Vạn_Độc_Môn/       ← 20+ nhân vật
│   ├── Đan_Hà_Cốc/        ← 19+ nhân vật
│   ├── Cổ_Nguyệt_Thần_Giáo/ ← 15+ nhân vật
│   └── ...
├── Thiên_Trụ/
│   ├── Đại_Càn_Hoàng_Triều/ ← 16+ nhân vật
│   ├── Cửu_U_Ma_Tông/      ← 14+ nhân vật
│   └── ...
├── Đông_Hoang/              ← 311 nhân vật
├── Vô_Tận_Hải/              ← 221 nhân vật
├── Bắc_Băng/                ← 120 nhân vật
├── Tây_Mạc/                 ← 116 nhân vật
└── Tán_Tu/                  ← 6 nhân vật
```
...
- **Vô Tận Hải**: Viết ch 11-16 (Arc 2 — Đại Dương Nổi Sóng)
...
**Bắc Băng (2 nhân vật):**
- [x] **Sở Lăng Sương** (`Góc_Nhìn_Sở_Lăng_Sương/`): Đã viết ch 9-10 (Arc 1 xong). Chủ đề: Sương độc, truy vết Huyết Tinh Sa, phá hủy Huyết Trì ở Băng Ngục Thành. Gặp gỡ Lý Tuyết Ưng.
...
- [x] **Nguyệt Dao** (`Góc_Nhìn_Nguyệt_Dao/`): Đã viết ch 7-10. Chủ đề: Nữ Hoàng Tinh Linh, bảo vệ Thần Mộc, thanh tẩy Huyết Độc, phá bỏ luật lệ cô lập, phái Lục Tiêu đi Nam Cương.
- [x] **Nham Thần** (`Góc_Nhìn_Nham_Thần/`): Đã viết ch 7-10. Chủ đề: Thức tỉnh, địa mạch, bảo vệ đất đai.
...
### Ghi Chú
> Đã hoàn thành Task 9 cho 3 nhân vật San Hô Đảo Quốc (Vô Tận Hải): Hải Nguyệt Ca, Hải Vân Dao, Hải Tiểu Loa.
...
> Đã hoàn thành Task 9 cho 3 nhân vật Phù Du Linh Đoàn (Vô Tận Hải): Linh Quang Mẫu, Linh Bích Hải, Linh Tiểu Quang.
...
> Đã hoàn thành Task 9 cho 3 nhân vật Hàn Kiếm Cốc (Bắc Băng): Hàn Tiêu, Hoàng Đoạn Tuyết, Lê Kiếm Tâm.
> Đã hoàn thành Task 9 cho 3 nhân vật Kim Sa Tự (Tây Mạc): Giới Trần, Huệ Minh, Không Độ.
...
├── Chương_Truyện/             ← Các chương truyện (nhóm theo khu vực)
│   ├── Nam_Cương/             ← Góc_Nhìn_Nam_Cương, Góc_Nhìn_Diệp_Tĩnh_Sương, ...
│   ├── Bắc_Băng/              ← Góc_Nhìn_Bắc_Băng, Góc_Nhìn_Lý_Tuyết_Ưng, ...
│   ├── Đông_Hoang/            ← Góc_Nhìn_Đông_Hoang, Góc_Nhìn_Lục_Ly, ...
│   ├── Vô_Tận_Hải/            ← Góc_Nhìn_Vô_Tận_Hải, Góc_Nhìn_Lệ_Nhược_Thủy, ...
│   ├── Tây_Mạc/               ← Góc_Nhìn_Tây_Mạc, Góc_Nhìn_Hứa_Nhược_Thủy, ...
│   └── Thiên_Trụ/             ← Góc_Nhìn_Thiên_Trụ
├── Thế_Giới_Và_Thời_Gian/    ← Địa lý, bản đồ, timeline
├── Nhân_Vật/                  ← Hồ sơ nhân vật (Khu Vực → Phe Phái → Nhân Vật)
...
### ✅ KHI TẠO CHƯƠNG MỚI:
1. Tạo file `.md` trong `Đạo/Chương_Truyện/[Khu_Vực]/[Góc_Nhìn]/Chương_NNNNN_Tên_Chương.md`
...
Nếu một góc nhìn phụ có **ít hơn 50% số chương** so với Góc Nhìn Nam Cương hoặc các góc nhìn khác → **catch-up ưu tiên**:
- Viết liên tục cho góc nhìn bị tụt cho đến khi bắt kịp timeline chính
...
```
1. Góc Nhìn Nam Cương      (2 chương)
2. [Góc nhìn phụ 1]        (1 chương)
3. Góc Nhìn Nam Cương      (2 chương)
4. [Góc nhìn phụ 2]        (1 chương)
5. Góc Nhìn Nam Cương      (2 chương)
6. [Góc nhìn phụ 3]        (1 chương)
7. (Lặp lại từ bước 1)
```

**Quy tắc:**
- Góc Nhìn Nam Cương luôn chiếm **2 phần** mỗi vòng.
...
| File nhân vật chỉ có khung | **Task 9**: `python3 scripts/find_unfilled_chars.py 3` → đọc thế lực → điền II-V |
