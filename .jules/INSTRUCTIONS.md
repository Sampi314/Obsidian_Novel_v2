...
| Góc Nhìn A Ngốc | 22 | Arc 4 — Rừng Huyết Độc | Đang viết catch-up redesign (Task 8) |
...
1. **Redesign A Ngốc (Task 8)**: Tiếp tục viết Góc Nhìn A Ngốc theo spec mới. Bắt đầu từ Arc 4 (Ch.23-26). **ĐỌC SPEC TRƯỚC:** `docs/superpowers/specs/2026-03-13-a-ngoc-arc-redesign.md`
