...
1. **Redesign A Ngốc (Task 8)**: Hoàn thành Arc 8. Cần chuyển sang viết Lệ Vô Tâm Bridge Arc (Ch.137-152 POV Lệ Vô Tâm) TRƯỚC khi viết Arc 9 cho A Ngốc, theo đúng Spec.
