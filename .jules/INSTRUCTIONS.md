...
| Góc Nhìn A Ngốc | 18 | Arc 3 — Bước Chân Vào Thế Giới | Đang viết catch-up redesign (Task 8) |
...
1. **Redesign A Ngốc (Task 8)**: Tiếp tục viết Góc Nhìn A Ngốc theo spec mới. Bắt đầu từ Arc 3 (Ch.19-22). **ĐỌC SPEC TRƯỚC:** `docs/superpowers/specs/2026-03-13-a-ngoc-arc-redesign.md`
