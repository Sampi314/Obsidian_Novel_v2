...
<div style="text-align: center; margin-bottom: 20px;">
    <table style="width: 100%; text-align: center; border: none;">
        <tr>
            ...
            <td style="border: none; padding: 5px;"><a href="Chương_00000_5_Thử_Thách_Đầu_Tiên.md">Chương Sau ➡️</a></td>
        </tr>
    </table>
    <details style="margin-top: 10px;">
        ...
        <ul style="max-height: 200px; overflow-y: auto; list-style: none; padding: 0; text-align: left;">
            <li style="padding: 5px; font-weight: bold; background-color: #f0f0f0;"><a href="Chương_00000_Tuyết_Phủ_Mộ_Phần.md">Chương 0: Tuyết Phủ Mộ Phần</a></li>
