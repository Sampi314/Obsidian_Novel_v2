...
race: Nhân Tộc
dao_tam: 'Thanh tĩnh thủ tâm, nguyệt quang thường tại'
age: 46
avatar: ''
faction_rank: Nội Môn Đệ Tử — Nguyệt Hoa Phong
arcs:
  - arc: 1
    status: Còn Sống
    cultivation: Trúc Cơ Hậu Kỳ
    methods: [Cửu Hoa Kiếm Quyết, Nguyệt Hoa Huyễn Ảnh Kiếm]
    inventory:
    ...
    relationships:
      ...
      - character: Lâm Tĩnh Tâm
        description: Sư huynh Chân Truyền cùng tộc, người nàng luôn thầm ngưỡng mộ và coi là biểu tượng của sự tĩnh tại trong tâm hồn.
        feelings: {yeu: 45, han: 0, kinh: 30, tin: 85, so: 0, on: 20}
      - character: Nguyệt Tĩnh Sương
        description: Tỷ muội đồng môn, người nàng thường xuyên cùng chia sẻ những tâm đắc về việc kết hợp thiền định vào kiếm ý.
        feelings: {yeu: 60, han: 0, kinh: 10, tin: 80, so: 0, on: 10}
      - character: Lão Lý Quét Sân
        description: Vị lão bộc hiền hậu mà nàng coi như người thân, nàng thường xuyên tặng lão thuốc bổ để lão sống khỏe mạnh.
        feelings: {yeu: 50, han: 0, kinh: 10, tin: 90, so: 0, on: 40}
      - character: Vũ Nguyệt Nhi
        description: Sư tỷ Chân Truyền, người nàng kính trọng về thiên phú và luôn nỗ lực để một ngày được đứng cùng hàng ngũ với nàng.
        feelings: {yeu: 15, han: 0, kinh: 50, tin: 75, so: 0, on: 0}
---
