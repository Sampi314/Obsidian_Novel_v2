...
```mermaid
graph TD
    TT[Tộc Trưởng: Kình Thiên Hải] --> TL[Hội Đồng Trưởng Lão]
    TL --> HVQ[Hộ Vệ Quân]
    TL --> CS[Ca Sĩ Bộ Lạc]
    HVQ --> CB[Chiến Binh]
