...
## I. Tổng Quan (总览)
> *"Tri thức không nên bị độc quyền — kẻ giấu sách là kẻ giấu đường sống của người khác."*
> — Thư Lão, câu nói nổi tiếng nhất trong giới tán tu

> *"Nơi đây không có sư phụ, không có đệ tử — chỉ có người đọc và người viết."*
> — Dòng chữ khắc trên cổng đá dẫn vào Kho Sách Chính
...
Gần đây, một tán tu mang đến một mảnh sách cổ viết bằng thứ văn tự không ai đọc được — Thư Lão nhận ra nó thuộc cùng hệ thống với cuốn sách bị khóa kín trong phòng riêng của lão. Đây là manh mối đầu tiên trong bốn trăm năm về phần còn lại của bộ công pháp mà lão đang tìm kiếm, và Thư Lão đã trả giá gấp mười lần bình thường để giữ mảnh sách này.
